...
```bash
curl -LO https://github.com/locainin/ProtonInformer/releases/download/v0.1.3/proton-informer-v0.1.3-linux-x86_64.tar.gz
curl -LO https://github.com/locainin/ProtonInformer/releases/download/v0.1.3/proton-informer-v0.1.3-linux-x86_64.tar.gz.sha256
sha256sum --check proton-informer-v0.1.3-linux-x86_64.tar.gz.sha256
tar -xzf proton-informer-v0.1.3-linux-x86_64.tar.gz
cd proton-informer-v0.1.3-linux-x86_64
```
